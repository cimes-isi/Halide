...
#define HALIDE_BUFFER_FORWARD_INITIALIZER_LIST(method, ...)                                            \
    ...
    HALIDE_BUFFER_FORWARD_CONST(global_dim)
    HALIDE_BUFFER_FORWARD_CONST(width)
    HALIDE_BUFFER_FORWARD_CONST(height)
    HALIDE_BUFFER_FORWARD_CONST(channels)
    HALIDE_BUFFER_FORWARD_CONST(global_width)
    HALIDE_BUFFER_FORWARD_CONST(global_height)
    HALIDE_BUFFER_FORWARD_CONST(global_channels)
